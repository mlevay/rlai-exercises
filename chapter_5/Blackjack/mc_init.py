...
from .constants import DIR_ABS_PATH, DIR_REL_PATH_INIT, PICKLE_FILE_NAME_INIT_EPISODES, PICKLE_FILE_NAME_INIT_PI
...
class MonteCarloInit():
    ...
    def _get_file_paths(self) -> (str, str):
        ...
        return os.path.join(rel_path, PICKLE_FILE_NAME_INIT_EPISODES), os.path.join(rel_path, PICKLE_FILE_NAME_INIT_PI)   
